...
3. Docusaurus builds the site
  ↓
4. Static HTML deployed to `<site-name>.docusapiens.site`
  ↓
...
2. Push to GitHub
3. Visit [app.docusapiens.ai](https://app.docusapiens.ai), click "Connect Repo"
4. Done! Your site is live at `<site-name>.docusapiens.site`
